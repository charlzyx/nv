  ...
  shortcuts: [
    ...
    [
      ...
      ([, d]) =>
        `transition-opacity-${
          Number(d) * 100
        } hover:opacity-50 hover:transition-opacity-${Number(d) * 100}`,
    ],
    [
      "input-group-border-left",
      "border rd-1.5 rd-br-0 rd-tr-0 dark:border-#333 border-#eaeaea",
    ],
    [
      "input-group-border-right",
      "border rd-1.5 rd-bl-0 rd-tl-0 dark:border-#333 border-#eaeaea focus:dark:border-#888 focus:border-#666 input-border-focus-animation",
    ],
  ],
  theme: {
    colors: {
