...
export const BaseInfo = () => {
	...
	return (
		<div className="flex justify-between text-3">
			<div>
				<div className="flex text-5 mb-3 mt-3 lh-8">
...
export default function SystemIno() {
	...
	return (
        ...
        <div className="i-carbon:chip text-4 mr-3 mt-0.5" />
				<div className="flex text-3.8 mr-4 w-12 keepword">
					处理器
				</div>
				<div>
			...
			{graphic ? (
				<div className="flex items-top sm:flex-col sm:children:mb-2sm:flex-row">
